...
console.log("====[04] MyMath 생성자 함수로 생성한 객체의 __proto__객체");
var math = new MyMath();
console.log(math.__proto__=== MyMath.prototype);

console.log("====[05] 리터럴 {}로 정의한 객체의 __proto__객체");
var obj = {};
...
math.substact = function(a,b) {
    return a - b;
}
console.log(math.substact(10, 20));

console.log("=== [09] prototype 객체의 __proto__속성 확인");
...
console.log("=== [11] Function.prototype 객체 __proto__ 확인");
console.log(MyMath.__proto__ === Function.prototype);

console.log("=== [12] Function.prototype 객체 속성 사용헤보기");
